...
public class Timer {
    ...
    public String start(boolean reset) {
        ...
        if (this.startTime != null) {
            if (reset) {
                ...
                throw new RuntimeException("Timer has been started. Use reset parameter to restart the timer.");
            }
        }
    ...
    public String end() {
        ...
        if (this.endTime != null) {
            throw new RuntimeException("Timer has been ended. Reset timer and use start method.");
        }
